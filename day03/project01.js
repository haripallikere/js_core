...
function  calculateDogAge(puppyAge,humanAge) {
    return `Your doggie is ${7*puppyAge} old in dog years!`;
}
...
function calculateSupply (age, amount) {
    const maxage = 90;
    var age;
    return `You will need $ ${(Math.round(amount*365))*(maxage-age)} to last you until the ripe old age of ${maxage}`;
}
